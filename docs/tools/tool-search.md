...
tools, and policy-required delivery tools directly visible. Core read/write/edit/exec tools are not added to the deferred catalog; call them by name instead of wrapping them in tool_call. Other authorized
