      ...
      ...(record.transcriptPath && shouldImportTranscript
        ? {
            readTranscriptEvents:
              result.status === "malformed"
                ? createTranscriptEventPrefixReader(record.transcriptPath, record.entry.sessionId)
                : createTranscriptEventReader(record.transcriptPath, record.entry.sessionId),
          }
        : {}),
